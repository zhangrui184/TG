...
class generatesumm:
    ...
    def generate_summary(self, file_name, folder,stop_words,word_embeddings,top_n):
       ...
       # stop_words = stopwords.words('zh')
        ...
        for wdfile in wdfiles:
         # 将word文件放到指定的路径下面
            ...
            objj=generatesumm()
            #创建方法
            ww,line_split=objj.generate_summary(filethename,folder,stop_words,word_embeddings,30)
...
if __name__ == '__main__':
    ...
    print("www")
    obj= readfile()
    obj.readthefile('D:\python project me\data\my_seq_attn/train\TG_slove',word_embeddings)
